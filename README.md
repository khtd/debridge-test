...
> Note: Due to a zero budget for this project, only free APIs, limited RPC endpoints and small free VPC were used.  
...
- **Price fetching** is mocked for test purposes instead of real CoinGecko API (also implemented).   
